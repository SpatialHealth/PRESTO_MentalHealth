...
myVars <- c("ageatqstn", "race_ethnic_factors", "educ_factors", "income_factors", "b_totalmet", "ttp_entry", "parity", "ct_HHinc", "ct_lths", "ct_urban_cat", "pss_score", "b_mdi_score")
...
# Assign variables for table one 
myVars <- c("ageatqstn", "race_ethnic_factors", "educ_factors", "income_factors", "b_totalmet", "ttp_entry", "parity",  "ct_HHinc", "ct_lths", "ct_urban_cat", "pss_score", "b_mdi_score", "ndvi_100_amax", "ndvi_100_smax", "ndvi_100_smean")
catVars <- c( "race_ethnic_factors", "educ_factors",  "income_factors", "ct_urban_cat")
```
