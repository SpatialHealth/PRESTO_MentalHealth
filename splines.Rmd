...
spline1 <- gam(pss_score~ s(ndvi_100_amax, fx=TRUE, k=3) + ageatqstn + b_race_ethnic_census + b_educ + b_income + b_totalmet + ct_lths , data = df, na.action=na.omit )
spline2 <- gam(b_mdi_score~ s(ndvi_100_amax, fx=TRUE, k=3) + ageatqstn + b_race_ethnic_census + b_educ + b_income + b_totalmet  + ct_lths , data = df, na.action=na.omit )
