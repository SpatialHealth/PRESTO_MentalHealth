...
# Export 
```{r, Export}
cycles_table2 <- rbind(pss_cycles, mdi_cycles)
parity_table2 <- rbind(pss_parity, mdi_parity)

write.csv(cycles_table2, file = "C:/Users/camer/OneDrive/Documents/SPH/PRESTO/sensitivity/cycles_table2.csv")
write.csv(parity_table2, file = "C:/Users/camer/OneDrive/Documents/SPH/PRESTO/sensitivity/parity_table2.csv")
